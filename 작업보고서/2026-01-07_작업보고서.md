...
### 11. AI 번호판 인식 기술 교육 자료 작성
- 파일 위치: `/home/uttec/today/esp32Camera/docs/ai_license_plate_recognition_guide.md`
- 목적: 번호판 인식 AI 기술을 초보자도 이해할 수 있도록 설명
- 포함 내용:
  - 전체 프로세스 개요 (5단계)
  - 이미지 전처리 기법 (그레이스케일, 노이즈 제거, 이진화)
  - **번호판 검출 AI**: YOLO, CNN 상세 설명
  - **문자 인식 AI**: OCR, Tesseract, EasyOCR
  - 신경망, CNN, LSTM 개념 설명
  - 시각적 다이어그램으로 이해하기 쉽게 구성
